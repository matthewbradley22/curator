...
This is a basic example of retriving data from gbif (get_records_since_date), flagging it with CoordinateCleaner (flag_data), and flagging any species names in the data that do not occur in the example ECD provided in the package.
