...
The next step is to flag any occurrences in which the species is in a country in whcih it does not occur in the ECD. For each of these new flagging steps the user can pass the whole "Flagged" object from above, and can indicate any important column names if they differ from the expected names.
